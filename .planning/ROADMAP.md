...
Plans:
- [ ] 01-01-PLAN.md — Streaming extract + parse a real export into CSV (tracer): bootstrap (ESM/tsconfig/deps), fflate Unzip (AppleDouble skip), timestamp/message parsing, RFC-4180 UTF-8-no-BOM CSV write, commander CLI
